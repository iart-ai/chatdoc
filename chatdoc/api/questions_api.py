...
class QuestionsApi:
    ...
    @validate_call
    def ask_question_questions_post(
        self,
        question_req: QuestionReq,
        ...
        :param question_req: (required)
        :type question_req: QuestionReq
        ...
        _param = self._ask_question_questions_post_serialize(
    ...
    @validate_call
    def ask_question_questions_post_with_http_info(
        self,
        question_req: QuestionReq,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def ask_question_questions_post_without_preload_content(
        self,
        question_req: QuestionReq,
        _request_timeout: Union[
            None,
    ...
    def _ask_question_questions_post_serialize(
        self,
        question_req,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def ask_question_with_multiple_documents_questions_multi_documents_post(
        self,
        question_req_with_upload_ids: QuestionReqWithUploadIds,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param question_req_with_upload_ids: (required)
        :type question_req_with_upload_ids: QuestionReqWithUploadIds
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._ask_question_with_multiple_documents_questions_multi_documents_post_serialize(
            question_req_with_upload_ids=question_req_with_upload_ids,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def ask_question_with_multiple_documents_questions_multi_documents_post_with_http_info(
        self,
        question_req_with_upload_ids: QuestionReqWithUploadIds,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def ask_question_with_multiple_documents_questions_multi_documents_post_without_preload_content(
        self,
        question_req_with_upload_ids: QuestionReqWithUploadIds,
        _request_timeout: Union[
            None,
    ...
    def _ask_question_with_multiple_documents_questions_multi_documents_post_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if question_req_with_upload_ids is not None:
            _body_params = question_req_with_upload_ids
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/questions/multi-documents',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_question_questions_question_id_get(
        self,
        ...
        _param = self._get_question_questions_question_id_get_serialize(
    ...
    @validate_call
    def get_question_questions_question_id_get_with_http_info(
        self,
        question_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_question_questions_question_id_get_without_preload_content(
        self,
        question_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_question_questions_question_id_get_serialize(
        self,
        question_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_suggested_questions_questions_suggested_get(
        self,
        upload_id: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="document id or collection id, created by `POST /documents/upload` or `POST /collections` APIs accordingly.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param upload_id: document id or collection id, created by `POST /documents/upload` or `POST /collections` APIs accordingly. (required)
        :type upload_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_suggested_questions_questions_suggested_get_serialize(
            upload_id=upload_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_suggested_questions_questions_suggested_get_with_http_info(
        self,
        upload_id: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="document id or collection id, created by `POST /documents/upload` or `POST /collections` APIs accordingly.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_suggested_questions_questions_suggested_get_without_preload_content(
        self,
        upload_id: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="document id or collection id, created by `POST /documents/upload` or `POST /collections` APIs accordingly.")],
        _request_timeout: Union[
            None,
    ...
    def _get_suggested_questions_questions_suggested_get_serialize(
        self,
        upload_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/questions/suggested',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
