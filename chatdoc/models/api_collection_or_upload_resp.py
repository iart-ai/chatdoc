...
from chatdoc.models.document_status import DocumentStatus
from chatdoc.models.upload_ocr_type import UploadOcrType
from chatdoc.models.upload_type import UploadType
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class APICollectionOrUploadResp(BaseModel):
    """
    ...
    type: UploadType
    documents: Optional[List[APIUploadResp]] = None
    error_msg: Optional[DocumentErrorMessage] = None
    ocr_type: Optional[UploadOcrType] = None
    __properties: ClassVar[List[str]] = ["id", "status", "name", "created_at", "type", "documents", "error_msg", "ocr_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of error_msg
        if self.error_msg:
            _dict['error_msg'] = self.error_msg.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "documents": [APIUploadResp.from_dict(_item) for _item in obj.get("documents")] if obj.get("documents") is not None else None,
            "error_msg": DocumentErrorMessage.from_dict(obj.get("error_msg")) if obj.get("error_msg") is not None else None,
            "ocr_type": obj.get("ocr_type")
        })
        return _obj
