...
class APIPackageInfoResp(BaseModel):
    """
    APIPackageInfoResp
    """ # noqa: E501
    page: Optional[PackageDataResp] = None
    question: Optional[PackageDataResp] = None
    lite_page: Optional[PackageDataResp] = None
    basic_page: Optional[PackageDataResp] = None
    elite_page: Optional[PackageDataResp] = None
    documents_tokens: Optional[PackageDataResp] = None
    gpt4_question: Optional[PackageDataResp] = None
    ocr_page: Optional[PackageDataResp] = None
    __properties: ClassVar[List[str]] = ["page", "question", "lite_page", "basic_page", "elite_page", "documents_tokens", "gpt4_question", "ocr_page"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of lite_page
        if self.lite_page:
            _dict['lite_page'] = self.lite_page.to_dict()
        # override the default output from pydantic by calling `to_dict()` of basic_page
        if self.basic_page:
            _dict['basic_page'] = self.basic_page.to_dict()
        # override the default output from pydantic by calling `to_dict()` of elite_page
        if self.elite_page:
            _dict['elite_page'] = self.elite_page.to_dict()
        # override the default output from pydantic by calling `to_dict()` of documents_tokens
        if self.documents_tokens:
            _dict['documents_tokens'] = self.documents_tokens.to_dict()
        # override the default output from pydantic by calling `to_dict()` of gpt4_question
        if self.gpt4_question:
            _dict['gpt4_question'] = self.gpt4_question.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ocr_page
        if self.ocr_page:
            _dict['ocr_page'] = self.ocr_page.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "page": PackageDataResp.from_dict(obj.get("page")) if obj.get("page") is not None else None,
            "question": PackageDataResp.from_dict(obj.get("question")) if obj.get("question") is not None else None,
            "lite_page": PackageDataResp.from_dict(obj.get("lite_page")) if obj.get("lite_page") is not None else None,
            "basic_page": PackageDataResp.from_dict(obj.get("basic_page")) if obj.get("basic_page") is not None else None,
            "elite_page": PackageDataResp.from_dict(obj.get("elite_page")) if obj.get("elite_page") is not None else None,
            "documents_tokens": PackageDataResp.from_dict(obj.get("documents_tokens")) if obj.get("documents_tokens") is not None else None,
            "gpt4_question": PackageDataResp.from_dict(obj.get("gpt4_question")) if obj.get("gpt4_question") is not None else None,
            "ocr_page": PackageDataResp.from_dict(obj.get("ocr_page")) if obj.get("ocr_page") is not None else None
        })
        return _obj
