...
from chatdoc.models.apiai_model_enum import APIAIModelEnum
from chatdoc.models.interaction_type import InteractionType
try:
...
class QuestionResp(BaseModel):
    ...
    source_info: List[Any]
    search_entire_doc: StrictBool
    detailed_citation: StrictBool
    id: StrictInt
    model_type: APIAIModelEnum
    __properties: ClassVar[List[str]] = ["question", "answer", "created_at", "type", "source_info", "search_entire_doc", "detailed_citation", "id", "model_type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "search_entire_doc": obj.get("search_entire_doc"),
            "detailed_citation": obj.get("detailed_citation"),
            "id": obj.get("id"),
